...
module Node : sig
  ...
  include ([%js :
             ...
             val children: untyped -> untyped array [@@js.get]
             ...
             val text_content: untyped -> string [@@js.get]
           ])
  type 'a t = untyped
...
module Element : sig
  ...
  val set_onclick: 'a t -> ('a t -> unit) -> unit
  val set_ondbclick: 'a t -> (unit -> unit) -> unit
  val set_onblur: 'a t -> (unit -> unit) -> unit
  val set_onfocus: 'a t -> (unit -> unit) -> unit
  val set_onchange: 'a t -> (unit -> unit) -> unit
  val set_onmouseover: 'a t -> (unit -> unit) -> unit
  val set_onkeyup: 'a t -> ('a t -> unit) -> unit
  val set_oninput: 'a t -> (unit -> unit) -> unit
  ...
  val options: 'a t -> 'a t array
  val selected_index: 'a t-> int

  val content_editable: 'a t -> bool
  val set_content_editable: 'a t -> bool -> unit
end = struct
  include [%js :
             ...
             val set_onclick: untyped -> (untyped -> unit) -> unit [@@js.set]
             val set_ondbclick: untyped -> (unit -> unit) -> unit [@@js.set]
             val set_onblur: untyped -> (unit -> unit) -> unit [@@js.set]
             val set_onfocus: untyped -> (unit -> unit) -> unit [@@js.set]
             val set_onchange: untyped -> (unit -> unit) -> unit [@@js.set]
             val set_onmouseover: untyped -> (unit -> unit) -> unit [@@js.set]
             val set_onkeyup: untyped -> (untyped -> unit) -> unit [@@js.set]
             val set_oninput: untyped -> (unit -> unit) -> unit [@@js.set]
             val tag_name: untyped -> string [@@js.get]

             val content_editable: untyped -> bool [@@js.get]
             val set_content_editable: untyped -> bool -> unit [@@js.set]
             val options: untyped -> untyped array [@@js.get]
             val selected_index: untyped -> int [@@js.get]
             val key: untyped -> string [@@js.get]
             val detail: untyped -> int [@@js.get]
           ]
  type 'a t = untyped
  let t_of_js _ x = untyped_of_js x
  let t_to_js _ x = untyped_to_js x
